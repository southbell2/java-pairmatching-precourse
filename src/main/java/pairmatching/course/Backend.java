...
public class Backend implements Crew{
    ...
    private final List<String> initBackCrews;
    ...
    protected Backend(MakeCrew makeCrew) {
        this.initBackCrews = makeCrew.makeCrewList("backend-crew.md");
    ...
    public List<String> getShuffledCrews() {
        return Randoms.shuffle(initBackCrews);
    }
}
